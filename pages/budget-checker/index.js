...
const BudgetPage = ({ items }) => {
  ...
  //const [budgetItem, setBudgetItem] = useState([]);infinite loop
  ...
  return (
    <>
      ...
      {/* trying to see if i get the right output <ul>
        {itemList.map((item) => {
...
// the first way i tried to approach creating the app was this and it was really bad
// import DiapForm from "@/components/diapchecks/DiapForm";
// //import OrderForm from "@/components/diapchecks/OrderForm";
// import Card from "@/components/ui/Card";
// import styles from "@/styles/Home.module.css";
// import { useEffect, useState } from "react";
// import FormItem from "@/components/diapchecks/FormItem";
// import BudgetForm from "@/components/diapchecks/BudgetForm";
// import DropdownQuantityPrice from "@/components/diapchecks/DropdownQuantityPrice";
// const BudgetPage = ({ items }) => {
...
//   // The state to store the selected item quantity
//   const [quantity, setQuantity] = useState(1);

//   // The state to store the budget amount
//   const [budget, setBudget] = useState("");
//   // The state to store the visibility of the fomItem component
//   const [visible, setVisible] = useState(false);
//   // The state to store the formItems list
...
//   // A handler function to toggle the visibility of the formItem component, needs fixing though
...
//               <DropdownQuantityPrice items={items} />
